...
class MainMenuElements:
    monitor, configure, events, settings = [
        f'//*[@id="page-menu-inner"]/a[{i}]' for i in range(1, 5)
    ]
    (
        configure_groups,
        configure_devices,
...
class EventElements:
    event_delete_all_button = (
        'input[type="submit"][name="deleteAll"][value="Delete All"]'
    )
    event_save_to_csv_file_button = (
        'input[type="submit"][name="savetocsv"][value="Save to a CSV file"]'
    )
...
class ConfigureGroupElements:
    ...
    group_default_event_configuration_button = (
        'input[type="submit"][name="action][value="Set to default"]'
    )
...
class ConfigureChannelElements:
    ...
    channel_delete_button = (
        'input.black-button[type="submit"][name="action"][value="Delete"]'
    )
    channel_copy_button = (
        'input.black-button[type="submit"][name="action"][value="Copy"]'
    )
    channel_export_button = (
        'input.black-button[type="submit"][name="action"][value="Export"]'
    )
...
class ConfigureInputElements:
    ...
    input_common_modulated_audio_track = (
        'select[id="/source/modulatedAudioTrack"][name="/source/modulatedAudioTrack"]'
    )
    ...
    input_udp_crypto_key_length = (
        'select[id="/source/mpeg2/srtPbkeylen"][name="/source/mpeg2/srtPbkeylen"]'
    )
    ...
    input_udp_video_id = (
        'input[type="text"][id="/source/videoId"][name="/source/videoId"]'
    )
    input_udp_audio_id = (
        'input[type="text"][id="/source/audioId"][name="/source/audioId"]'
    )
    ...
    input_rtp_sdp_file = (
        'input[type="text"][id="/source/rtp/sdpFile"][name="/source/rtp/sdpFile"]'
    )

    # RTMP Options CSS Selector
    input_rtmp_url = (
        'input[type="text"][id="/source/rtmp/url"][name="/source/rtmp/url"]'
    )
    ...
    input_playlist_type = (
        'select[id="/source/fileList/type"][name="/source/fileList/type"]'
    )
    input_playlist_playlists_name = (
        'select[id="/source/fileList/fileName"][name="/source/fileList/fileName"]'
    )
    input_playlist_clipcasting_uri = (
        'input[type="text"][id="/source/fileList/url"][name="/source/fileList/url"]'
    )
    input_playlist_remote_media_asset_uri = (
        'input[type="text"][id="/source/fileList/url"][name="/source/fileList/url"]'
    )
    input_playlist_recurring_the_last_n_files = 'input[type="text"][id="/source/fileList/recurring"][name="/source/fileList/recurring"]'
    input_playlist_sort_by = (
        'select[id="/source/fileList/sortMode"][name="/source/fileList/sortMode"]'
    )
    ...
    input_ndi_group = (
        'input[type="text"][id="/source/ndi/groupName"][name="/source/ndi/groupName"]'
    )
    input_ndi_url = 'input[type="text"][id="/source/ndi/url"][name="/source/ndi/url"]'

    # SDI Options CSS Selector
    input_sdi_signal_type = (
        'select[id="/source/sdi/signalType"][name="/source/sdi/signalType"]'
    )
    input_sdi_video_format = (
        'select[id="/source/sdi/videoStandard"][name="/source/sdi/videoStandard"]'
    )
    input_sdi_1080p_30mode = (
        'select[id="/source/sdi/sdi1080p30Mode"][name="/source/sdi/sdi1080p30Mode"]'
    )
    input_sdi_1080p_60mode = (
        'select[id="/source/sdi/sdi1080p60Mode"][name="/source/sdi/sdi1080p60Mode"]'
    )
    input_sdi_2160p_30mode = (
        'select[id="/source/sdi/sdi2160p30Mode"][name="/source/sdi/sdi2160p30Mode"]'
    )
    input_sdi_2160p_60mode = (
        'select[id="/source/sdi/sdi2160p60Mode"][name="/source/sdi/sdi2160p60Mode"]'
    )
    input_sdi_enable_ha_mode = 'select[id="/source/sdi/enableHighAvailabilityMode"][name="/source/sdi/enableHighAvailabilityMode"]'
    input_sdi_time_code_type = (
        'select[id="/source/sdi/timeCodeType"][name="/source/sdi/timeCodeType"]'
    )
    input_sdi_aspect_ratio = (
        'select[id="/source/sdi/aspectRatio"][name="/source/sdi/aspectRatio"]'
    )
    input_sdi_timed_text_source = (
        'select[id="/source/sdi/timedTextSource"][name="/source/sdi/timedTextSource"]'
    )
    input_sdi_teletext_page = (
        'input[type="text"][id="/source/sdi/wstPage"][name="/source/sdi/wstPage"]'
    )
...
class ConfigureOutputElements:
    ...
    output_add_output_button = (
        'span.orange-button-nopad[onclick="redirectToCreateURL()"]'
    )
    ...
    output_udp_primary_output_address = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[5]/span/input"
    )
    output_udp_primary_output_port = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[6]/span/input"
    )
    output_udp_primary_network_interface = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[8]/span/select"
    )
    output_udp_secondary_output_address = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[9]/span/input"
    )
    output_udp_secondary_output_port = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[10]/span/input"
    )
    output_udp_secondary_network_interface = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[12]/span/select"
    )
    output_udp_multicast_ttl = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[13]/span/input"
    )
    output_udp_tos = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[14]/span/input"
    )
    output_udp_ts_id = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[16]/span/input"
    )
    output_udp_program_number = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[17]/span/input"
    )
    output_udp_service_name = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[18]/span/input"
    )
    output_udp_service_provider = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[19]/span/input"
    )
    output_udp_pmt_pid = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[20]/span/input"
    )
    output_udp_pcr_pid = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[21]/span/input"
    )
    output_udp_psi_interval = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[22]/span/input"
    )
    output_udp_mux_rate = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[23]/span/input"
    )
    output_udp_null_packet_padding = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[25]/span/select"
    )
    output_udp_on_input_loss = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[26]/span/select"
    )
    output_udp_dvb_subtitle_track_checkbox = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[28]/span/input"
    )
    output_udp_dvb_subtitle_track = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[29]/span/input"
    )
    output_udp_dvb_teletext_track_checkbox = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[31]/span/input"
    )
    output_udp_dvb_teletext_track = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[32]/span/input"
    )
    output_udp_enable_scte_35_passthru = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[35]/span/input"
    )
    output_udp_enable_id3_tden_tag = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[37]/span/input"
    )
    output_udp_enable_ts_over_rtp = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[38]/span/input"
    )
    output_udp_srt = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[42]/span/input"
    )
    output_udp_ats_ebp_checkbox = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[49]/span/input"
    )
    output_udp_ats_ebp_fragment_duration = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[50]/span/input"
    )
    output_udp_ats_ebp_segment_duration = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[51]/span/input"
    )
    output_udp_vct_checkbox = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[52]/span/input"
    )
    output_udp_vct_table_id = "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[53]/span[2]/span/select"
    output_udp_vct_short_name = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[53]/span[3]/span/input"
    )
    ...
    output_udp_vct_source_id = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[53]/span[8]/span/input"
    )
    # CSS Selector : Radio button
    output_udp_broadcasting_standard_atsc = (
        'input[type="radio"][name="Broadcasting standard:"][value="0"]'
    )
    output_udp_broadcasting_standard_dvb = (
        'input[type="radio"][name="Broadcasting standard:"][value="1"]'
    )

    # HLS output options
    # Both ID and Name are the same, so it is used as full XPATH.
    output_hls_segment_naming = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[3]/span/select"
    )
    output_hls_duration = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[6]/span/input"
    )
    output_hls_segments_ring_size = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[7]/span/input"
    )
    output_hls_keep_remote_segments = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[8]/span/input"
    )
    output_hls_primary_master_playlist_path = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[9]/span/input"
    )
    output_hls_backup_master_playlist_path = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[10]/span/input"
    )
    output_hls_primary_playback_url = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[11]/span/input"
    )
    output_hls_backup_playback_url = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[12]/span/input"
    )
    output_hls_master_playlist_name = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[13]/span/input"
    )
    output_hls_subtitle_playlist_name = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[14]/span/input"
    )
    output_hls_subtitle_type = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[15]/span/select"
    )
    output_hls_dvb_subtitle = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[16]/span/input"
    )
    output_hls_dvb_teletext = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[19]/span/input"
    )
    output_hls_create_subfolder = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[22]/span/input"
    )
    output_hls_create_iframe_playlist = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[23]/span/input"
    )
    output_hls_tagging_playlists_with_timestamp = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[24]/span/input"
    )
    output_hls_scte35_signaling = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[25]/span/select"
    )
    output_hls_enable_id3_tden_tag = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[26]/span/input"
    )
    output_hls_enable_encryption = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[27]/span/input"
    )
    output_hls_append_endlist_at_stop = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[38]/span/input"
    )

    # RTSP output option
    output_rtsp_publishing_point = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[2]/span/input"
    )

    # RTMP output options
    output_rtmp_broadcast_address = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[2]/span/input"
    )
    output_rtmp_secondary_address = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[3]/span/input"
    )
    output_rtmp_broadcast_port = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[4]/span/input"
    )
    output_rtmp_broadcast_path = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[5]/span/input"
    )
    output_rtmp_secondary_path = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[6]/span/input"
    )
    output_rtmp_stream_name = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[7]/span/input"
    )
    output_rtmp_connection_timeout = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[8]/span/input"
    )
    output_rtmp_send_timeout = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[9]/span/input"
    )
    output_rtmp_subtitle_language = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[10]/span/select"
    )
    output_rtmp_cdn_authentication = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[11]/span/select"
    )
    output_rtmp_username = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[12]/span/input"
    )
    output_rtmp_password = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[13]/span/input"
    )

    # Live Smooth Streaming output options
    output_lss_fragment_duration = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[3]/span/input"
    )
    otuput_lss_publishing_server_type = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[4]/span/select"
    )
    output_lss_time_scale = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[5]/span/select"
    )
    output_lss_hevc_codec_tag = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[6]/span/select"
    )
    output_lss_publishing_point_url = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[7]/span/input"
    )
    output_lss_secondary_point_url = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[8]/span/input"
    )
    output_lss_ismt_properties = 'input[type="radio"][name="ISMT Properties"]'
    output_lss_dvb_subtitle = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[10]/span/input"
    )
    output_lss_dvb_teletext = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[13]/span/input"
    )
    output_lss_enable_secte35 = 'input[type="radio"][name="Enable SCTE35"]'
    output_lss_stream_naing = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[17]/span/select"
    )
    output_lss_playready_drm = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[18]/span/select"
    )
    output_lss_on_input_loss = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[30]/span/select"
    )
    output_lss_send_mfra_at_stop = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[31]/span/input"
    )

    # DASH output options
    output_dash_mpd_name = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[3]/span/input"
    )
    output_dash_mpd_update_interval = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[4]/span/input"
    )
    output_dash_primary_base_url = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[5]/span/input"
    )
    output_dash_primary_path = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[6]/span/input"
    )
    output_dash_secondary_base_url = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[7]/span/input"
    )
    output_dash_secondary_path = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[8]/span/input"
    )
    output_dash_segment_naming = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[9]/span/select"
    )
    output_dash_segments_ring_size = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[10]/span/input"
    )
    output_dash_segment_duration = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[11]/span/input"
    )
    output_dash_min_buffer_time = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[13]/span/input"
    )
    output_dash_mode = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[14]/span/select"
    )
    output_dash_segment_template_mode = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[15]/span/select"
    )
    output_dash_hevc_codec_tag = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[16]/span/select"
    )
    output_dash_subtitle_type = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[17]/span/select"
    )
    output_dash_scte35_signalling = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[18]/span/input"
    )
    output_dash_drm_type = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[20]/span/select"
    )

    # CMAF output options
    output_cmaf_ingest_protocol = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[4]/span/select"
    )
    output_cmaf_base_publishing_point = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[5]/span/input"
    )
    output_cmaf_enable_low_latency_transfer = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[6]/span/input"
    )
    output_cmaf_http_method = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[7]/span/select"
    )
    output_cmaf_create_subfolder = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[8]/span/input"
    )
    output_cmaf_segment_naming = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[9]/span/select"
    )
    output_cmaf_dvr_window_length = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[10]/span/input"
    )
    output_cmaf_min_buffer_time = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[11]/span/input"
    )
    output_cmaf_segment_duration = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[12]/span/input"
    )
    output_cmaf_chunk_duration = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[13]/span/input"
    )
    output_cmaf_hevc_codec_tag = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[14]/span/select"
    )
    output_cmaf_dvb_sutitle_track = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[17]/span/input"
    )
    output_cmaf_dvb_teletext_track = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[20]/span/input"
    )
    output_cmaf_scte35_signalling = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[23]/span/input"
    )
    output_cmaf_enable_id3 = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[26]/span/input"
    )
    output_cmaf_use_utc_in_tfdt = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[27]/span/input"
    )
    output_cmaf_use_negative_time_offset_in_trun = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[28]/span/input"
    )
    output_cmaf_drm_type = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[29]/span/select"
    )
    output_cmaf_dash_segment_template_mode = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[53]/span/select"
    )
    output_cmaf_dash_mpd_name = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[54]/span/input"
    )
    output_cmaf_hls_master_playlist_name = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[55]/span/input"
    )
    otuput_cmaf_append_endlist_at_stop = (
        "/html/body/div/div[4]/div/div[1]/div/div[2]/div[3]/span[57]/span/input"
    )
...
class ConfigureVideopresetElements:
    ...
    videopreset_resolution = (
        'select[id="videoResizeSetting"][name="videoResizeSetting"]'
    )
    videopreset_frame_rate = (
        'input[type="text"][id="/video/frameRate"][name="/video/frameRate"]'
    )
    videopreset_bframe = (
        'input[type="text"][id="/video/bframes"][name="/video/bframes"]'
    )
    videopreset_bitrate = (
        'input[type="text"][id="/video/bitrate"][name="/video/bitrate"]'
    )
...
class ConfigureAudiopresetElements:
    ...
    audiopreset_mpeg_version = (
        'select[id="/audio/mpegVersion"][name="/audio/mpegVersion"]'
    )
    ...
    audiopreset_sampling_rate = (
        'select[id="/audio/samplingRate"][name="/audio/samplingRate"]'
    )
...
class ConfigureTaskElements:
    ...
    task_replacement_image = (
        'select.inputbox[id="/task/replacementImage"][name="/task/replacementImage"]'
    )
    ...
    task_recurring_weekly_mo = (
        'input[type="checkbox"][id="recurringWeeklyMo"][name="Mo"]'
    )
    task_recurring_weekly_tu = (
        'input[type="checkbox"][id="recurringWeeklyTu"][name="Tu"]'
    )
    task_recurring_weekly_we = (
        'input[type="checkbox"][id="recurringWeeklyWe"][name="We"]'
    )
    task_recurring_weekly_th = (
        'input[type="checkbox"][id="recurringWeeklyTh"][name="Th"]'
    )
    task_recurring_weekly_fr = (
        'input[type="checkbox"][id="recurringWeeklyFr"][name="Fr"]'
    )
    task_recurring_weekly_sa = (
        'input[type="checkbox"][id="recurringWeeklySa"][name="Sa"]'
    )
    task_recurring_weekly_su = (
