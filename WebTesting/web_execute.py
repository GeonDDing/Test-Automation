...
input_playlist_options = {
    'Type': 'Local Static Playlist',
    'Playlists name': 'kt_tvn'
}
...
if __name__ == "__main__":
    ...
    # audiopreset_instance.configure_audiopreset(profile_name['Audiopreset Name'], audiopreset_options)
    # videopreset_instance.configure_videopreset(profile_name['Videopreset Name'], videopreset_options)
