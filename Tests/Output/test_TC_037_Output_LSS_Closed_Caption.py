...
@allure.suite("Output")
class TestOutputLSSClosedCaption:
    test_configuration_data = {
        ...
        "Channel Name": "Output LSS Closed Caption Testing",
        "Input Type": "UDP",
        "Output Type": "LSS",
    ...
    def get_channel_stats(self, **kwargs):
        with allure.step("Get Channel Stats"):
            ...
            output_url = f"http://{self.test_configuration_data['Output Options']['Publishing Point URL']}/.m3u8"
    ...
    def test_output_lss_closed_caption(self):
        print("\n")
        test_functions = [
            self.login,
            self.create_channel,
