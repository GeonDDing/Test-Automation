...
pytestmark = [allure.epic("WebUI Test Automation"), allure.feature("RTSP Output")]


@allure.parent_suite("WebUI Test Automation")
@allure.suite("Output")
class TestOutputRTSP:
    test_configuration_data = {
        ...
        "Channel Name": "Output RTSP Testing",
        "Input Type": "Playlist",
        "Output Type": "RTSP",
        ...
        "Output Options": {
            "Publishing Point": "rtsp://10.1.0.145:8554/live/rtsp_test",
        },
    ...
    def get_channel_stats(self, **kwargs):
        with allure.step("Get Channel Stats"):
            ...
            output_url = f"{self.test_configuration_data['Output Options']['Publishing Point']}"
