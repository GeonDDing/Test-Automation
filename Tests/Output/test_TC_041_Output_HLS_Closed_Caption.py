...
@allure.suite("Output")
class TestOutputHLSClosedCaption:
    test_configuration_data = {
        ...
        "Channel Name": "Output HLS Closed Caption Testing",
        "Input Type": "UDP",
        "Output Type": "HLS",
        ...
        "Output Options": {
            ...
            "Primary Master playlist path": "videos/test_automation_041/",
    ...
    def test_output_hls_closed_caption(self):
        print("\n")
        test_functions = [
            self.login,
            self.create_channel,
