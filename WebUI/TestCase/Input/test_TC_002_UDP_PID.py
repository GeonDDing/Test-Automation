...
# sys.path.append(os.path.dirname(os.path.abspath(os.pa th.dirname(os.path.abspath(os.path.dirname(__file__))))))
...
class TestUDPInputPID:
    test_configuration_data = {
        ...
        "Channel Name": "Input UDP PIDs Testing",
        "Input Type": "UDP",
        "Output Type": "UDP",
