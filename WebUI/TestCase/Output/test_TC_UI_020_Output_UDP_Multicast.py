...
class TestOutputUDPMulticast:
    test_configuration_data = {
        ...
        "Channel Name": "Output UDP Multicast Testing",
        "Input Type": "Playlist",
        "Output Type": "UDP",
        ...
        "Output Options": {
            "Primary Output Address": "224.30.30.10",
            "Primary Output Port": "15020",
            "Primary Network Interface": "NIC2",
        },
